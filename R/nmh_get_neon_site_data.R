#' Download site data from the NEON website
#' 
#' @author Nick Marzolf, \email{nick.marzolf@@jonesctr.org}
#' @author Wes Slaughter, \email{wslaughter@@berkeley.edu}
#' 
#' @param download logical. If TRUE, file is saved as a csv to the specified directory
#' 
#' @export

nmh_get_neon_site_data <- function(dest_dir = 'data/',
